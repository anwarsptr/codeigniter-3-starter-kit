...
$config['base_url'] = $protocol.$hostName.$dirName.'/';
...
|
*/
$config['log_threshold'] = (int) @$_ENV['LOG_THRESHOLD'];
...
$config['csrf_token_name'] = 'csrf_anwarsptr';
$config['csrf_cookie_name'] = 'csrf_cookie_anwarsptr';
