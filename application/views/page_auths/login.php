<div class="login-box">
  <div class="login-logo">
    <img src="<?= checkImg($web_app['logo'], 'logo') ?>" style="max-height:100px;"/><br>
  ...
  <div class="login-box-body border-radius shadow">
    ...
    <form id="formAuthentication" method="POST" action="javascript:postSubmit('formAuthentication', '<?= current_url().'/process' ?>', '<?= $base_url.'dashboard' ?>')" data-parsley-validate="true">
